...
<div id="Abstract_Felipe_2024_PINN" style="display: none; position: fixed; top: 10%; right: 2%; width: 40%; height: auto; background-color: rgba(0, 0, 0, 0.7);">
<div style="position: absolute; background-color: white; margin: 10px; padding: 10px; width: 100%; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
...
<h2 style="font-size: 18px;" style="color:blue;">Learning characteristic parameters and dynamics of centrifugal pumps under multiphase flow using physics-informed neural networks</h2>
<h3 style="font-size: 18px;" style="color:blue;">Abstract</h3>
<p style="font-size: 12px;" style="color:blue;" style="text-align: justify;">
