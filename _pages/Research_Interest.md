...
My broad area of research is in Uncertainty quantification, Stochastic Finite Element Method (SFEM), Scientific Machine Learning, Health Monitoring
</p>
...
<p style='text-align: justify;'> 
I am currently working on machine learning (ML) based operator learning and health monitoring and the inverse problem of real-world dynamical systems using physics-informed neural networks. </p>

<p style='text-align: justify;'> For future work, I am interested in continuing my study on numerical methods for the solution of stochastic systems extending to non-linear systems and studying ML and its applications. </p>
