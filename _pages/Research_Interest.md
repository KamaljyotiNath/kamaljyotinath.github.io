...
<p style='text-align: justify;'> 
Physics-informed neural networks (PINNs) take into account the physics of the problem while evaluating the parameter by encoding the ODEs/PDEs of the system in the loss function. I am currently working on inverse problems using PINN for real-world dynamical systems. </p>
